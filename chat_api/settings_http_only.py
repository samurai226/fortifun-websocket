# chat_api/settings_http_only.py
...
CORS_ALLOWED_ORIGINS = [
    ...
    'http://localhost:8080',
    'http://127.0.0.1:8080',
    'https://fortifun-app.vercel.app',
    'https://fortifun-app.netlify.app',
]
...
AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME', 'fortifun-media')
